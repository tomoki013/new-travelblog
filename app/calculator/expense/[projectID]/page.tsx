...
// const ExpensePage = ({ params }: { params: { projectId: string } }) => {
//     // URLデコードを行う
...
//                     <li><strong>現在は一人での利用を想定したバージョンです。</strong>URLを共有しても、他の人があなたの入力内容を見ることはできません。</li>
//                      <li>安全のため、本名や電話番号などの個人情報は入力しないでください。</li>
//                 </ul>
//             </div>
...
const ExpenseProjectPage = () => {
    return (
        <p>このページは作成中です</p>
    )
}

export default ExpenseProjectPage;
