...
const ExpenseClient = ({ projectID }: { projectID: string }) => {
    ...
    // 依存配列にisLoadingを追加して、読み込み状態の変更を検知する
    }, [projectID, isLoading]);
    // (*** ここまで修正 ***)
    ...
    return (
        <>
            <div className='flex items-center justify-center m-4 md:hidden'>
                <Button>
                    <Link href={`#paymentResult`}>清算結果を見る</Link>
                </Button>
            </div>
            <div className="space-y-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <Card className="bg-primary/5" id='paymentResult'>
                            <CardHeader>
                            ...
                            <CardContent>
                                 ...
                                 ) : <p className="text-muted-foreground text-center">精算はまだありません。</p>}
                            </CardContent>
                        </Card>
                    </div>
                </div>
