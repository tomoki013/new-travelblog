...
const SeriesCard = ({ series, postsLength }: SeriesCardProps) => {
      ...
      >
        ...
        <div className="relative z-10 flex flex-col h-full">
          ...
          <div className="flex-grow flex flex-col justify-center items-center text-center">
            {IconComponent && (
              <IconComponent size={32} className="mb-4 drop-shadow-lg" />
            )}
          ...
          <div className="mt-auto pt-4 border-t-2 border-white/20">
            <div className="flex items-center gap-2 text-sm">
              ...
              <span className="font-semibold text-amber-300">発見した物語</span>
              <div className="flex-grow border-b-2 border-dotted border-white/30 mx-2"></div>
              <span className="font-bold text-lg">{postsLength}</span>
            </div>
          </div>
        </div>
      </motion.div>
